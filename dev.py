...
source_code_pending_validation = sourceCodeRepository.find_source_codes(status=source_code_status, limit=5)
optimiser = SVM_BO_optimiser()
db = BO_evaluation_db()
svm_kernel_lengthscale_prior_means = range(0.1, 2, 0.1)
svm_kernel_outputscale_prior_means = np.arange(0.1,2,0.2)
svm_C_lengthscale_prior_means = np.arange(0.1,10, 1)
svm_C_outputscale_prior_means = np.arange(0.1, 2,0.2)
svm_gamma_lengthscale_prior_means = np.arange(0.1,1,0.1)
svm_gamma_outputscale_prior_means = np.arange(0.1,2,0.2)
svm_coef0_lengthscale_prior_means = np.arange(0.1,0.5,0.1)
svm_coef0_outputscale_prior_means = np.arange(0.1,2,0.2)
                            ...
                            for coef0_l_mean in svm_coef0_lengthscale_prior_means:
                                for coef0_o_mean in svm_coef0_outputscale_prior_means:
                                    ...
                                    result_to_save = {
                                        ...
                                        "BO_hyperparameters": {
                                            "svm_kernel_lengthscale_prior_mean": kernel_l_mean,
                                            "svm_kernel_outputscale_prior_mean" : kernel_o_mean,
                                            "svm_C_lengthscale_prior_mean" : C_l_mean,
                                            "svm_C_outputscale_prior_mean" : C_o_mean,
                                            "svm_gamma_lengthscale_prior_mean": gamma_l_mean,
                                            "svm_gamma_outputscale_prior_mean" : gamma_o_mean,
                                            "svm_coef0_lengthscale_prior_mean": coef0_l_mean,
